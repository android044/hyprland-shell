...
class Toaster : public QObject {
    ...
    Q_PROPERTY(QQmlListProperty<hyprlandsh::Toast> toasts READ toasts NOTIFY toastsChanged)
...
public:
    ...
    Q_INVOKABLE void toast(const QString& title, const QString& message, const QString& icon = QString(),
        hyprlandsh::Toast::Type type = Toast::Type::Info, int timeout = 5000);
